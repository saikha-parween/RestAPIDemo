...
public class UserController {
    ...
    public ResponseEntity<UserDTO> getCustomerDetails(@PathVariable @Min(value = 1, message = "{customer userId invalid}") @Max(value = 100, message = "{customer userId invalid}") Integer userId) throws ApplicationException {
...
//    }
    ...
    public ResponseEntity<Object> updateCustomer(@PathVariable Integer userId, @RequestBody UserDTO customer)
