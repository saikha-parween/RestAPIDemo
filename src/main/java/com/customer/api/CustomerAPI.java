...
public class CustomerAPI {
	...
	public ResponseEntity<CustomerDTO> getCustomerDetails(@PathVariable @Min(value = 1, message = "{customer customerid invalid}") @Max(value = 100, message = "{customer customerid invalid}") Integer customerId)  throws BankException{
	...
	public ResponseEntity<String> addAddress(@Valid @RequestBody AddressDTO addressDTO) throws BankException {
		Integer Id = customerService.addAddress(addressDTO);
